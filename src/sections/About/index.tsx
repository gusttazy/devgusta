            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-white/70 max-w-2xl mx-auto">
                        Um breve resumo sobre minha trajetória profissional, acadêmica e pessoal.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(180px,auto)]">
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold text-white mb-4">
                            Desenvolvedor Fullstack apaixonado por resolver problemas reais.
                        </h3>
                        <p className="text-zinc-400 leading-relaxed mb-6 text-lg">
                            Olá! Sou Gustavo Rodrigues de Aguiar. Meu foco é transformar ideias complexas em
                            software elegante e performático. Combinando criatividade técnica com uma base sólida em engenharia.
                        </p>
                    ...
                    >
                        <div className="absolute top-0 right-0 p-4 opacity-50 group-hover:opacity-100 transition-opacity">
                            <Code2 className="text-zinc-600 group-hover:text-[#00ff9d]" size={40} />
                        </div>
